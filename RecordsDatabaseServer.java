...
public class RecordsDatabaseServer {
    ...
    public RecordsDatabaseServer(){
        ...
        try {
            ...
            //TO BE COMPLETED
            int maxConnectionsQueue = 3;
            serverSocket = new ServerSocket(thePort, maxConnectionsQueue, InetAddress.getByName(theIPAddress));
    ...
    public void executeServiceLoop()
    {
        ...
        try {
            ...
            while (true) {
                ...
                RecordsDatabaseService tempServiceThread = new RecordsDatabaseService(aSocket);
